...
import { UnicesarGuard } from './auth/unicesar.guard';
import { VerificaCorreoComponent } from './proyectos/components/verifica-correo/verifica-correo.component';
...
export const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [UnicesarGuard],

  },
  {
  path: 'verifica-correo',
  component: VerificaCorreoComponent
  },
  {
    path: 'log',
